...
import worknasi.adapter.ReservedSpaceAdapetr;
...
public class ReservedSpaces extends AppCompatActivity {

    private static String TAG = ReservedSpaces.class.getSimpleName();
    private static String URL_RESERVEDSPACE = AppConfig.LINK_RESERVEDSPACE;

    private ListView listView;
    private ReservedSpaceAdapetr reservedSpaceAdapetr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reserved_spaces);
        ...
        reservedSpaceAdapetr = new ReservedSpaceAdapetr(ReservedSpaces.this,getApplicationContext(),reservedSpaceList);
    ...
    private void LoadFeed(final int offsetsize) {
        ...
        //start a new request
        StringRequest jsonReq = new StringRequest(Request.Method.POST,URL_RESERVEDSPACE, new Response.Listener<String>() {
