...
public class ReservedSpaceAdapetr extends BaseAdapter {
    private String TAG = ReservedSpaceAdapetr.class.getSimpleName();
    ...
    public ReservedSpaceAdapetr(Activity activity,Context context,List<ItemReservedSpace> reservedSpaceList) {
