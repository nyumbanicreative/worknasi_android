...
import worknasi.helper.FlipAnimator;
...
public class MessagesAdapter extends RecyclerView.Adapter<MessagesAdapter.MyViewHolder> implements Filterable{
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnLongClickListener {
        ...
        public MyViewHolder(View view) {
            ...
            content_container = (RelativeLayout) view.findViewById(R.id.content_container);
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    listener.onMessageSelected(messagesFiltered.get(getAdapterPosition()));
                }
            });
        }
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (Message row : messages) {
                        ...
                        if (row.getFrom().toLowerCase().contains(charString.toLowerCase()) || row.getMessage().contains(charSequence)) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                messagesFiltered = (ArrayList<Message>) filterResults.values;
                notifyDataSetChanged();
            }
        };
    }
